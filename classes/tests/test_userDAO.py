...
class TestUserDAO(unittest.TestCase):
    ...
    def test_check_pin(self):
        user = User(None, "Bektur Momunov", "5555666677778888", "9999", 3000.0)
        self.user_dao.add_user(user)
    ...
    def test_delete_user(self):
        user = User(None, "Baiastan Zamirbekov", "9999000011112222", "1111", 4000.0)
        self.user_dao.add_user(user)
